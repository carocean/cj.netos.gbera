...
import 'package:gbera/portals/common/azlistview/azlistview.dart';
...
class _ContactListState extends State<ContactList> {
  ...
  void loadData() async {
    //加载联系人列表
    rootBundle.loadString('lib/portals/gbera/data/contacts.json').then((value) {
        ...
        SizedBox(
          ...
          child: ListTile(
            ...
            onTap: () {
              ...
              widget.context.forward('/contact/viewer');
            },
          ),
        )
      ],
