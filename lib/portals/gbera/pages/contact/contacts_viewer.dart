...
class ContactsViewer extends StatefulWidget {
  static const String routeName = '/contacts';
  PageContext context;

  ContactsViewer({this.context});

  @override
  ContactsViewerState createState() => ContactsViewerState();
}

enum AppBarBehavior { normal, pinned, floating, snapping }

class ContactsViewerState extends State<ContactsViewer> {
