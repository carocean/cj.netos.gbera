...
class ProfileFace extends StatefulWidget {
  PageContext context;

  ProfileFace({this.context});

  @override
  _ProfileFaceState createState() => _ProfileFaceState();
}

class _ProfileFaceState extends State<ProfileFace> {
  File _image;
  var _background;
  File _crop_image;
