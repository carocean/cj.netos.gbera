...
class ChatRoomAvatar extends StatefulWidget {
  PageContext context;

  ChatRoomAvatar({this.context});

  @override
  _ChatRoomAvatarState createState() => _ChatRoomAvatarState();
}

class _ChatRoomAvatarState extends State<ChatRoomAvatar> {
  File _image;
  var _background;
  File _crop_image;
          ...
          _image == null
              ...
              : IconButton(
                  onPressed: () async {
                    ...
                    _image = null;
                    setState(() {
                      widget.context.backward(result: <String,Object>{'image':_crop_image.path});
                    });
                  },
